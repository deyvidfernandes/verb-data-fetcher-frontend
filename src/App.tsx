	...
	return (
		<GlobalStateProvider>
			<div className='mx-auto max-w-6xl flex flex-col items-center gap-12 mb-12'>
				...
				<Section title='About'>
					<p className='leading-7'>
						The Verb Data Fetcher is a tool designed to enrich data about irregular verbs
						in English. Users input a JSON file containing verbs in infinitive, simple
						past, and present perfect formats. The application utilizes the Free
						Dictionary API to obtain detailed definitions and the Google NGram API to
						determine the usage frequency of verbs.
					</p>
					<p className='leading-7'>
						...
						frequencies. This enhanced file is then sent to the backend, where it
						undergoes analysis and is stored persistently as records in the database.
					</p>
					<p className='leading-7'>
						This tool was developed on a non-profit basis and is open under the MIT
						license. The generated data will be used to feed the Master of Tenses
						application, a final project for the Technical Systems Development course at
						ETEC.
					</p>
				</Section>
			</div>
			...
			<footer className='flex flex-col justify-center items-center w-full gap-1 py-2 text-white text-lg bg-brandOrange border-orange-800 border-t'>
				...
				<a
					href='https://github.com/deyvidfernandes/MasterOfTenses'
					target='_blank'
					rel='noreferrer'
					id='github-link'
				>
